                ...
                <div class="container">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="usuario" items="${listPaises}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${pais.name}" />
                                    </td>
                                   
                                    <td><a href="edit?id=<c:out value='${paise.id}' />">Editar</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="delete?id=<c:out value='${pais.id}' />">Elimnar</a></td>
                                </tr>
                            </c:forEach>
